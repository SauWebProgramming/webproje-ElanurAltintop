...
namespace InventoryBeginners.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public IActionResult Index(string sortExpression = "", string SearchText = "", int pg = 1, int pageSize = 5) // read method of the crud operations. it lists all data from action.
        {
            ...
            PaginatedList<Category> items = _Repo.GetItems(sortModel.SortedProperty, sortModel.SortedOrder, SearchText, pg, pageSize);//_context.Units.ToList();
        ...
        public IActionResult Create(Category item)
        {
            ...
            try
            {
                ...
                if (_Repo.IsItemExists(item.Name) == true)
                    ...
                    errMessage = errMessage + " " + " Category Name " + item.Name + " Exists Already";
