...
namespace InventoryBeginners.Controllers
{
    ...
    public class ProductProfileController : Controller
    {
        ...
        public IActionResult Index(string sortExpression = "", string SearchText = "", int pg = 1, int pageSize = 5) // read method of the crud operations. it lists all data from action.
        {
            ...
            PaginatedList<ProductProfile> items = _Repo.GetItems(sortModel.SortedProperty, sortModel.SortedOrder, SearchText, pg, pageSize);//_context.Units.ToList();
        ...
        public IActionResult Create(ProductProfile item)
        {
            ...
            try
            {
                ...
                if (_Repo.IsItemExists(item.Name) == true)
                    ...
                    errMessage = errMessage + " " + " Product Profile Name " + item.Name + " Exists Already";
            ...
            {
                TempData["SuccessMessage"] = "Product Profile" + item.Name + "Created Succesfully";
